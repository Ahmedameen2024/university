...
import 'package:flutter_application_10/dashbord/jopmanagment.dart';
import 'package:flutter_application_10/dashbord/research.dart';
import 'package:flutter_application_10/dashbord/table_collageData.dart';
import 'package:flutter_application_10/dashbord/table_departmentData.dart';
import 'package:flutter_application_10/dashbord/table_griduintData.dart';
import 'package:flutter_application_10/dashbord/tostion.dart';
import 'package:flutter_application_10/screen/chat_screen.dart';
import 'package:flutter_application_10/screen/collage.dart';
import 'package:flutter_application_10/screen/job.dart';
...
class HomepageDashbord extends StatefulWidget {
  // HomepageDashbord(BuildContext context);

  @override
  State<HomepageDashbord> createState() => _HomepageDashbordState();
}

class _HomepageDashbordState extends State<HomepageDashbord> {
  final NavController navController = Get.put(NavController());
  final GlobalKey<ScaffoldState> _scaffoldKey = GlobalKey<ScaffoldState>();
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      navController.currentPage.value = TableCollagedata();
    });
  }
  ...
  Widget buildNavigationRail() {
    return Container(
      ...
      child: ListView(
        children: [
          buildRailItem(Icons.chat, 'Collage_Dashbord', 0),
          buildRailItem(Icons.school, 'Department_Dashbord', 1),
          buildRailItem(Icons.work, 'Job_Dashbord', 2),
